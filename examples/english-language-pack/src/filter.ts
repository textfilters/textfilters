...
import { createProfanityFilterFromDictionary } from "../../../src/index.js";
import { normalizeLiteralTerm } from "../../../src/matchers/literals.js";
import { normalizeForMatchSameLenWithoutHomoglyphs } from "../../../src/normalization/text.js";
...
const maintainedRuleIds = new Set<string>(
  englishProfanityDictionary.rules.map((rule) => rule.id),
);
