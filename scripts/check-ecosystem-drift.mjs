...
const PACKAGES = [
  {
    ...
    fallbackRef: "9139572b06fc060f4e0e6a3bc30992e12ae27acd",
  ...
  },
  {
    ...
    fallbackRef: "6b6e48c4328bc0cb633b81333f5ef120a515a540",
  ...
  },
  {
    ...
    fallbackRef: "5538819c4d83da9b2bfb37d13b4b4b8bee6736bc",
    dependencyRange: EXPECTED_CORE_RANGE,
    files: ["dist", "docs", "README.md", "LICENSE"],
  },
  {
    ...
    fallbackRef: "6715f35eb3540bba14d07100c0430f1e45e88464",
    dependencyRange: EXPECTED_CORE_RANGE,
    files: ["dist", "docs", "README.md", "LICENSE"],
  },
  {
    ...
    fallbackRef: "2d2b1b12863b312b4c788f6455421c687d72c8ea",
    dependencyRange: EXPECTED_CORE_RANGE,
    files: ["dist", "docs", "README.md", "LICENSE"],
  },
  {
    ...
    fallbackRef: "6c26f6b7a300e48b2ba0f5b1b61487658fe7272f",
