...
The root integration install verifies that published packages resolve to a
single `@textfilters/core` line without npm overrides.
...
npm install @textfilters/core@^0.4.0 @textfilters/url @textfilters/email @textfilters/phone @textfilters/profanity @textfilters/spam
