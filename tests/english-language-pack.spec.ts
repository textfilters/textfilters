...
const reviewedCases = [
  ...
  ["dιckheads", "en.vulgar.dick", "VULGAR", "medium"],
  ...
  ["sυcked", "en.vulgar.suck", "VULGAR", "medium"],
  ["sυckιng", "en.vulgar.suck", "VULGAR", "medium"],
  ...
  ["αsshole", "en.insult.asshole", "STRONG_INSULT", "high"],
