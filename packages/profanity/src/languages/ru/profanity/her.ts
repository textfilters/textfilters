...
export default russianFamilyDictionary([
  ...
  russianRule({
    id: "ru.euphemism.her.base.split.loose",
    category: "EUPHEMISM",
    severity: "low",
  ...
  russianRule({
    id: "ru.euphemism.oheret.split.loose",
    category: "EUPHEMISM",
    severity: "low",
  ...
  russianRule({
    id: "ru.euphemism.oheret.translit.bare",
    category: "EUPHEMISM",
    severity: "low",
  ...
  russianRule({
    id: "ru.euphemism.her.prefixed.translit.bare",
    category: "EUPHEMISM",
    severity: "low",
  ...
  russianRule({
    id: "ru.euphemism.heret.translit.bare",
    category: "EUPHEMISM",
    severity: "low",
